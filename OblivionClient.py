...
def logando_main(tipo, mensagem):
    """
    :param tipo: Sets the log type.
    :param mensagem: Sets the message of log.
    :return: Returns the complete log's body.
    """
...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def historico_listar(self):
        """
        Lists all the scans listed on Oblivion's history/Lista todos os scans do histórico.
        """
        try:
            ...
            logando_main('error', 'Was not possible to load the history')
...
agenda_gerar_dadobruto={self.agenda_gerar_dadobruto.checkState(0)}""")
    ...
    def decript_f(self):
        """
        Fixes bar spaces in the path file of decrypt function/Arruma alguns espaços do path do arquivo que será
        descriptografado.
        """
    ...
    def loop_set(self):
        ...
        Note: this function has a delay to complete/Essa função apresenta um delay para ser concluida.
        """
